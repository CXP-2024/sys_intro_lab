...
extern LOAD LOAD_SELECT;            // 声明
extern COMPUTE COMPUTE_SELECT;      // 声明
extern COMPARE COMPARE_SELECT;      // 声明

extern uint32_t m;                  // 声明
extern uint32_t k;                  // 声明
extern uint32_t n;                  // 声明
